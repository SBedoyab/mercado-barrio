...
require_once __DIR__ . '/app/Builder/OrderBuilder.php';
require_once __DIR__ . '/app/Strategy/DeliveryStrategyInterface.php';
require_once __DIR__ . '/app/Strategy/DeliverySelector.php';
require_once __DIR__ . '/app/Strategy/MotoYAStrategy.php';
require_once __DIR__ . '/app/Strategy/EcoBikeStrategy.php';
require_once __DIR__ . '/app/Strategy/PaqzStrategy.php';
require_once __DIR__ . '/app/Adapter/DeliveryAdapterInterface.php';
require_once __DIR__ . '/app/Adapter/MotoYAAdapter.php';
require_once __DIR__ . '/app/Adapter/EcoBikeAdapter.php';
require_once __DIR__ . '/app/Adapter/PaqzAdapter.php';
